...
\author{Claudson Oliveira - 200822007 \\Adriele Alvarenga Secundino - 200822002}
\title{Tarbalho 2 - Análise de Agrupamentos} 
...
\section{Problema de Classificação - Base de Dados Wine }

O problema consiste em  classificar tipos de  vinho usando  13 atributos.
Para este trabalho usamos o método de agrupamento \textit{K-means}

Segue abaixo as informação sobre a base de dado  \textit{Wine}

Número de exemplares: 178

Atributos: 13 contínuos
\begin{itemize}
\item \textit{1} Alcalinity of ash 
 \item \textit{2} Achool
 \item \textit{3} Ash
\item \textit{4} Color intensity
 \item \textit{5} OD280/OD315 of diluted wines
\item \textit{6} Flavanoids
 \item \textit{7} Hue
 \item \textit{8} Magnesium 
 \item \textit{9} Malic acid  Alcohol 
\item \textit{10} Nonflavanoid phenols
 \item \textit{11} Proline
 \item \textit{12} Total phenols 
 \item \textit{13} Proanthocyanins
\end{itemize}
...
Fonte problema: banco de dados da UCI Machine learning
ftp://ftp.ics.uci.edu/pub/machine-learning-databases/wine

Discussão problema: ftp://ftp.ics.uci.edu/pub/machine-learning-
bases de dados / vinho
    
\section{Listagem das amostras da base dados}

Listagem das amostras da base de dados, acompanhadas da respectiva classe real e da
classe calculada pelo k-means, somente para a execução que apresentar o maior
percentual de acertos.:




\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|cl}
...
\hline
\end{tabular}
\caption{Resultados da Análise RS}
\end{table}
\end{center}

\section{Conclusão}

Analisando os resultados percebe-se que o método \textit{K-means} desenvolvido tem um desempenho mediano comparado ao Weka, porém o metodo se mostrou
adequado para resolver problemas de classificação, resolvendo rapidamente o problema com poucas iterações.
 ...
 * que nao cabiam ao grupo e nem a Wine
 * @author Claudson Oliveira
 */
