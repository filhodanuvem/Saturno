...
class ResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $table = $this->getMockForAbstractClass('Saturno\\Bridge\\DataTables\\Table');
    ...
    public function test_add_entity_valid_into_response()
    {
        $template = $this->getMock('Twig_Environment');
        $userTable = new \Saturno\DataTablesBundle\Tests\Fixtures\UserTable($template);
        ...
        $expected = json_encode($dataGrid);
        $response->addEntity(new User(1, 'Claudson Oliveira', '1990-05-28'));
