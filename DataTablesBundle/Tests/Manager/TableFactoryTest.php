...
class TableFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(
            array('AcmeFooBundle', 'Acme\FooBundle\AcmeFooBundle', 'AcmeFooBundle','Acme\FooBundle\Table\BarTable'),
            array('SaturnoAcmeFooBundle', 'Saturno\Acme\FooBundle\SaturnoAcmeFooBundle', 'SaturnoAcmeFooBundle','Saturno\Acme\FooBundle\Table\BarTable'),
            array('FooBarBazBrazilBundle', 'Foo\Bar\Baz\BrazilBundle\FooBarBazBrazilBundle', 'FooBarBazBrazilBundle','Foo\Bar\Baz\BrazilBundle\Table\CloudTable'),
        );
    }
